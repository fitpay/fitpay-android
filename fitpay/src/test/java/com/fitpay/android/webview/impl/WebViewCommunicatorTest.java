...
public class WebViewCommunicatorTest extends TestActions {
    ...
    public void testSendUserData() throws Exception {
        ...
        NotificationManager.getInstance().addListener(callbackListener, Schedulers.trampoline());
        ...
        WebViewCommunicator wvc = new WebViewCommunicatorImpl(context, new MockPaymentDeviceConnector(context), null);
